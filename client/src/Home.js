      ...
      <div className="bg-white shadow-lg rounded-lg p-11 w-2/3">
        ...
        <div className="space-y-4">
          ...
          <div className="bg-gray-50 p-4 rounded-lg border border-gray-200">
            <h3 className="text-lg font-medium text-blue-900">Upcoming Shipments</h3>
          ...
          {/* Credit Amount */}
          <div className="bg-gray-50 p-4 rounded-lg border border-gray-200">
            <h3 className="text-lg font-medium text-blue-900">Remaining Credit Amount</h3>
            <p className="bg-gray-200">
              {customer ? `$${customer.credit_amount}` : "No available credit amount."}
            </p>
          </div>
          <div className="flex justify-between space-x-4">
            <Link to="/book_shipment" className="bg-gray-700 text-white py-2 px-4 rounded-lg hover:bg-blue-900">
              Book a Shipment
            </Link>
            <Link to="/shipments" className="bg-gray-700 text-white py-2 px-4 rounded-lg hover:bg-blue-900">
              View Shipments
            </Link>
          </div>
        </div>
